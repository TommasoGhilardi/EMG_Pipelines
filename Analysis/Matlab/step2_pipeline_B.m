...
if exist('PipelineB', 'var')
    PipelineB  = [ PipelineB; data_export_not_corrected ];
else
    PipelineB = data_export_not_corrected;
end
...
if exist('PipelineB1', 'var')
    PipelineB1  = [ PipelineB1; d_data_export ];
else
    PipelineB1 = d_data_export;
end
...
if exist('PipelineB2', 'var')
    PipelineB2  = [ PipelineB2; s_data_export ];
else
    PipelineB2 = s_data_export;
end
